...
import getCroppedImg from '../utils/crop'; // A helper function to get the cropped image
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-teal-400 to-blue-500 p-4">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <button 
          onClick={handleCrop} 
          className="bg-blue-500 text-white px-4 flex justify-space-between py-2 rounded shadow hover:bg-blue-600 transition"
        >
          Crop
        </button>
        <button 
...
/// crop image using react-cropper ==== remove the command to run croping in this method
